...
export async function rateLimitByIp ( limit : number = 1 , interval : number = 1000000 ) {
    const ip = getIp();
...
export async function rateLimitByKey ( key : string , limit : number = 1 , interval : number = 1000000 ) {
